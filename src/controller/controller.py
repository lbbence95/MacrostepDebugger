...
def RegisterNode(infra_id, node_id, node_name, registration_timestamp, bp_id):
    ...
    if (infra_id != None and infra_id != "") and (node_id != None and node_id != "") and registration_timestamp != None:
        msteprepo.RegisterNode(infra_id, node_id, node_name, registration_timestamp, bp_id)
    else:
        # TO-DO: Throw some error
        pass
...
def RegisterBreakpoint(infra_id, node_id, registration_timestamp, bp_num, node_data):
    ...
    if (infra_id != None and infra_id != "") and (node_id != None and node_id != "") and bp_num > 0:
        msteprepo.RegisterBreakpoint(infra_id, node_id, registration_timestamp, bp_num, node_data)
    else:
        # TO-DO: Throw some error
        pass